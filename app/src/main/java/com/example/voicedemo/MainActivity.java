...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String CLIENT_ACCESS_TOKEN = "62KDPZOG3RBUARP6U5DBA6366VC5MQBP";
    ...
    private void respondToUser(String response) {
        ...
        try {
            ...
            if (intent == null) {
                textToSpeech.speak("Sorry, I didn't get that. ", TextToSpeech.QUEUE_FLUSH, null, UUID.randomUUID().toString());
                return;
            }
        ...
        if (intentName.equals("joke")) {
            responseText = "In a classroom Teacher asks a student to count from 0 to 10. Student : 0, 1, 2, 3, 4, 6, 7, 8, 9, 10\n" +
                    "Teacher : Where is 5?\n" +
                    "Student : Yesterday I heard in the news that 5 died in a car accident…..";
            textToSpeech.speak(responseText, TextToSpeech.QUEUE_FLUSH, null, UUID.randomUUID().toString());
        }
        if (intentName.equals("call")) {
            responseText = "calling";
            Intent intent = new Intent(Intent.ACTION_CALL
            );
            intent.setData(Uri.parse("tel:7028070850"));
        ...
        textToSpeech = new TextToSpeech(applicationContext, new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int ttsStatus) {
                ...
                if (ttsStatus == TextToSpeech.SUCCESS) {
                    if(CLIENT_ACCESS_TOKEN != "62KDPZOG3RBUARP6U5DBA6366VC5MQBP") {
                        ...
                        textToSpeech.speak("Hi! Welcome to our virtual voice assistant ", TextToSpeech.QUEUE_FLUSH, null, UUID.randomUUID().toString());
                    }
